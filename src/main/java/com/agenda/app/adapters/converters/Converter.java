package com.agenda.app.adapters.converters;
...
import com.agenda.app.adapters.input.dtos.ContatoResponse;
...
public class Converter {
    ...
    public ContatoEntity atualizarEntity(ContatoEntity entity, ContatoDomain domain) {
